...
from cs336_basics.nn import Linear, Embedding,RMSNorm, softmax, silu, SwiGLU
from cs336_basics.attention import scaled_dot_product_attention,RotaryPositionalEmbedding,MultiHeadSelfAttention
from cs336_basics.transformer import TransformerBlock, TransformerLM
from cs336_basics.training import cross_entropy,gradient_clipping,get_batch
from cs336_basics.training import (
    get_lr_cosine_schedule as get_lr_cosine_schedule_impl,
)
...
def run_transformer_block(
    ...
    token_positions = token_positions.unsqueeze(0).expand(
        in_features.shape[0],
        sequence_length,
    )
...
def run_transformer_lm(
    ...
    in_indices = in_indices.to(device=device)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return get_lr_cosine_schedule_impl(
        it=it,
