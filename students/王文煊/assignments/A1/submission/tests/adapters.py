...
def run_multihead_self_attention(
    ...
    """
    attn = MultiHeadSelfAttention(d_model, num_heads, use_rope=False, device=in_features.device)
...
def run_multihead_self_attention_with_rope(
    ...
    attn = MultiHeadSelfAttention(
        d_model, num_heads, max_seq_len=max_seq_len, theta=theta, use_rope=True, device=in_features.device
    )
    attn.q_proj.weight.data = q_proj_weight
    attn.k_proj.weight.data = k_proj_weight
    attn.v_proj.weight.data = v_proj_weight
