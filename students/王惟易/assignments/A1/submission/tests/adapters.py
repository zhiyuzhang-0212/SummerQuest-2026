...
def run_multihead_self_attention(
    ...
    """
    from cs336_basics.model import MHA

    mha = MHA(d_model, num_heads, device=q_proj_weight.device, dtype=q_proj_weight.dtype)
    mha.load_state_dict({
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    from cs336_basics.model import MHA, RoPE
    ...
    mha = MHA(d_model, num_heads, device=q_proj_weight.device, dtype=q_proj_weight.dtype, rope=rope)
    mha.load_state_dict({
        "q_proj.weight": q_proj_weight,
        "k_proj.weight": k_proj_weight,
        "v_proj.weight": v_proj_weight,
